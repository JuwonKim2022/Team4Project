   ...
   <body>
     ...
     $(".join_button").click(function(){  //가입 버튼 클릭하면 시작
         /* 입력값 변수 */
      ...
      if(mail == ""){
       ...
       if(idCheck&&idckCheck&&pwCheck&&pwckCheck&&nameCheck&&mailCheck){
    
         
            $("#join_form").attr("action", "${pageContext.request.contextPath}/member/join");
            $("#join_form").submit();         
            alert('전송 성공');
         }   else{
            alert('전송 실패');
